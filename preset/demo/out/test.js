...
function (_ReactVueLike) {
  ...
  _createClass(HomeMainSomeIndex, [{
    ...
    value: function render() {
      ...
      null,
      _react.default.createElement("h1", null, "HomeMainSomeIndex"),
        this.text, _react.default.createElement("br", null), "logined: ", String(this.logined), _react.default.createElement("br", null), _react.default.createElement("input", {
        value: _this.text,
        onChange: this._a(function (e) {
          _this.text = e && e.target ? e.target.value : e;
        })
...
HomeMainSomeIndex.__vuelike = true;
HomeMainSomeIndex.__file = "/preset/demo/src/test.js";
HomeMainSomeIndex.__flows = ["testAsync"];
